...
AppName=OpenCV SuperMegaTurboBackPostureCorrector
AppVersion=V1.05
DefaultDirName={pf}\SuperMegaTurboBackPostureCorrector
DefaultGroupName=SuperMegaTurboBackPostureCorrector
OutputBaseFilename=SuperMegaTurboBackPostureCorrector-setup
Compression=lzma
...
[Files]
Source: "SuperMegaTurboBackPostureCorrector\bin\x64\Release\SuperMegaTurboBackPostureCorrector.exe"; DestDir: "{app}"; 
Source: "SuperMegaTurboBackPostureCorrector\bin\x64\Release\*"; Excludes: "*.pdb,*.vshost*,AForge.xml,AForge.Video.xml,AForge.Video.DirectShow.xml,Emgu.CV.xml,Emgu.Util.xml"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\SuperMegaTurboBackPostureCorrector"; Filename: "{app}\SuperMegaTurboBackPostureCorrector.exe"
Name: "{commondesktop}\SuperMegaTurboBackPostureCorrector"; Filename: "{app}\SuperMegaTurboBackPostureCorrector.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\SuperMegaTurboBackPostureCorrector.exe"; Description: "{cm:LaunchProgram,SuperMegaTurboBackPostureCorrector}"; Flags: nowait postinstall skipifsilent
