...
namespace FaceFinderDemo.FaceDetection
{
    public class FaceFeatures
    {
        ...
        private void CalcProbableEyeLocation(int width, int height)
        {
            ...
            probableEyeLocation.Height = (int)(probableEyeLocation.Height / 2.7f);
        ...
        {
            int thickness = 2;
            if (!FaceLocation.IsEmpty && !LeftEyeLocation.IsEmpty && !RightEyeLocation.IsEmpty && !NoseLocation.IsEmpty)
